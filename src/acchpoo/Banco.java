...
public class Banco {
    ...
    public void inserirMercadoria(Mercadoria mercadoria) {
        String sql = "INSERT INTO Mercadoria(descricao, marca, tipo, quantidade) VALUES('"
                + mercadoria.getDescricao() + "','" + mercadoria.getMarca() + "','" + mercadoria.getTipo() + "','" + mercadoria.getQuantidade()+ "');";
