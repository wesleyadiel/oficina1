...
public class InicialController implements Initializable {
    ...
    private void SlcButtonAction(ActionEvent event) {
        try {
            ...
            Pane root = fxmlLoader.load(getClass().getResource(nome = "/TelaLogin/TelaLogin.fxml").openStream());
    ...
    private void rcButtonAction(ActionEvent event) {
        try {
            ...
            Pane root = fxmlLoader.load(getClass().getResource(nome = "/Cadastro/Cadastro.fxml").openStream());
            stage.setScene(new Scene(root, 500, 500));
            stage.showAndWait();
        } catch (IOException e) {
            e.printStackTrace();
