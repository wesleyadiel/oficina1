...
public class ControlarEstoqueMPController implements Initializable {
    ...
    public void pesquisarMercadoria() throws IOException, SQLException {
		...
		if(this.mercadoria.getIdTipo() == 1) {
			Mensagem.abrir("Atenção", "Lançamento de estoque", "Mercadoria não é do tipo materia prima, não pode ser lançado estoque de materia prima!", AlertType.WARNING);
			return;
		}
